...
namespace net {
    namespace socket_op {
        ...
        extern auto create_nonblocking_or_die(std::int8_t _family) -> util_socket_t;
        extern auto create_dgram_or_die(std::int8_t _family) -> util_socket_t;
        ...
        extern auto get_addr_len(std::int32_t _family) -> std::size_t;
